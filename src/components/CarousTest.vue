          ...
          <div class="slide_trainer_info_common">
            <div class="slide_trainer_info_left">
              <a :href="slide.trainerurl">
                <img
                  class="slide_trainer_img"
                  :src="getImgUrl(slide.trainerimg)"
                  alt=""
                />
                <div class="slide_rating">{{ slide.rating }}</div>
                <div class="slide_raitingdescription">
                  {{ slide.ratingdescription }}
                </div>
              </a>
            </div>
            <div class="slide_trainer_info_rigth">
              ...
              <div class="slide_trainer_career">
                <div
                  class="slide_trainer_work"
                  v-for="(work, i) in slide.career"
                  :index="i"
                  :key="i"
                >
                  <div class="slide_trainer_time">{{ work.time }}</div>
                  <div class="slide_trainer_desription">
                    {{ work.description }}
                  </div>
                </div>
              </div>
              ...
              <div class="slide_trainer_games">
                <div
                  class="slide_trainer_game"
                  v-for="(game, i) in slide.games"
                  :index="i"
                  :key="i"
                >
                  <a :href="game.url" class="a_trainer_game">
                    <img
                      class="slide_game_img"
                      :src="getImgUrl(game.gameimg)"
                      :alt="game.gamename"
                    />
                    <div class="slide_game_desription">
                      {{ game.description }}
                    </div>
                  </a>
                </div>
